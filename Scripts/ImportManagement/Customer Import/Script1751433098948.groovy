...
WebUI.click(findTestObject('Object Repository/testimportcustomer/Page_TEC Connect/span_Import Management') //testsuite runtime this line put in comment
    )
...
WebUI.setText(findTestObject('Object Repository/testimportcustomer/Page_TEC Connect/input__Prophet21ID'), '369789')

WebUI.setText(findTestObject('Object Repository/testimportcustomer/Page_TEC Connect/input__CustNmbr'), '1113')
