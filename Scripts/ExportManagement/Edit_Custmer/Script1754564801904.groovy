...
//WebUI.click(findTestObject('Object Repository/ExportManagement/Export_Customer/Page_TEC Connect/span_Export Management')) // when run the suite it's put this in comment 

//WebUI.delay(10)

WebUI.click(findTestObject('Object Repository/ExportManagement/Export_Customer/Page_TEC Connect/span_Export Customer'))

WebUI.click(findTestObject('ExportManagement/Edit_Customer/edit_button'))
...
WebUI.click(findTestObject('ExportManagement/Edit_Customer/Click_here_for_audit_log'))

WebUI.delay(3)

WebUI.click(findTestObject('ExportManagement/Edit_Customer/Export to excel'))

WebUI.delay(3)

WebUI.click(findTestObject('ExportManagement/Edit_Customer/FirstSvgDropDownArrow'))

WebUI.delay(3)

WebUI.scrollToElement(findTestObject('ExportManagement/Edit_Customer/Scrolltoelement'), 0)

WebUI.delay(5)

WebUI.scrollToElement(findTestObject('ExportManagement/Edit_Customer/BackToList'), 0)
