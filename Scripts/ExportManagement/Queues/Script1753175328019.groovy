...
WebUI.click(findTestObject('Object Repository/ExportManagement/Page_TEC Connect/span_Export Management' // When run suite, discard from comment.
        ))
...
WebUI.click(findTestObject('ExportManagement/Page_TEC Connect/span_Is not equal to'))
